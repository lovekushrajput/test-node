...
console.log(moment('2020-01-01').isValid()); // 2020-14-01
...
console.log(date1.diff(date2)); // 2.
// date1: 2014-11-27
// date2: 2015-09-16

var a = moment([2014, 11, 27]);
var b = moment([2015, 09, 16]);
console.log(a.diff(b)); // Check is 2020-01-01 date after 2018-01-01

console.log(moment('2020-01-01').isAfter('2018-01-01')); // Check is 2010-01-01 date after 2018-01-01

console.log(moment('2020-01-01').isAfter('2018-01-01')); // Check if the year 2019 is a leap year

console.log(moment([2019]).isLeapYear()); // Check if the year 2020 is a leap year

console.log(moment([2020]).isLeapYear()); //lodash five method of array
// 1-chunk method
...
var chracter = ['a', 'b', 'c', 'd', 'e', 'f', 'g'];
console.log(lodash.chunk(chracter, 2)); // 2-compact method
// Creates an array with all falsey values removed. The values false,
//  null, 0, "", undefined, and NaN are falsey.

var arr = [0, 1, false, 2, '', 3];
console.log(lodash.compact(arr)); // 3- concat method
// Creates a new array concatenating array with
//  any additional arrays and/or values.

var other = [1, 2, 3, 4];
console.log(lodash.concat(other, 67, [122], [[66]])); // 4- drop method
// Creates a slice of array with n elements dropped from the beginning.

var array = [23, 35, 12, 45];
console.log(lodash.drop(array, 3)); // 5- indexOf method
...
console.log(lodash.indexOf(array, 35)); // lodash five method of collection
// 1- filter method
...
console.log(lodash.filter(users, 'active')); // 2- find method
//   Iterates over elements of collection, returning the first element predicate returns truthy for.
//  The predicate is invoked with three arguments: (value, index|key, collection).

console.log(lodash.find(users, ['active', false])); // 3-forEach method
...
console.log(lodash.map(arr2, square)); // 5- shuffle method
